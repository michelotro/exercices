...
echo "<h1>Creer un tableau HTML qui contient des données en PHP</h1>";
echo "<h1>Villes de France</h1>";
?>


    <table class="table-bordered table-sm table-hover table-striped text-warning table-dark">
        <thead>
            <th>Ville</th>
            <th>département</th>
            <th>latitude</th>
...
?>
    ...
    <h1>Villes de France avec une autre écriture</h1>
    <table>
    <thead>
        <th>Ville</th>
        <th>département</th>
